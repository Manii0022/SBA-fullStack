...
const Dashboard = () => {
  ...
  const stats = [
    { label: 'Total Entries', value: '143', icon: BookOpen, color: 'text-blue-600' },
    { label: 'This Month', value: '20', icon: Calendar, color: 'text-green-600' },
    { label: 'Writing Streak', value: '5 days', icon: TrendingUp, color: 'text-purple-600' },
  ];
