...
function Home(){
    ...
    return(
        ...
        <p className=" h-100 w-full text-xl bg-amber-100 font-extrabold font-serif">
            ...
            Accusamus dignissimos eaque, nihil, debitis quisquam ullam ut autem facere voluptatum optio architecto dolore natus ab culpa corrupti veritatis quidem corporis velit earum provident iure! Expedita quibusdam nulla iste fugiat?
            Dolor voluptatem perferendis quaerat, assumenda unde, neque possimus, velit quia nam officiis provident. Deleniti neque ex soluta similique, odio magnam cum tenetur earum esse aut impedit sint placeat eligendi harum?
        </p>
        </>
    )
}
